...
WHERE DATEPART(MONTH, Date_Made__c) = 3 and DATEPART(Year, Date_Made__c) = 2017 and c.[Type] = 'Telemarketing' and c.noblesys__listId__c is not null
GROUP BY l.Id
...
WHERE DATEPART(MONTH, Date_Made__c) = 3 and DATEPART(Year, Date_Made__c) = 2017 and ch.act_date <= Date_Made__c
GROUP BY l.Id
...
WHERE DATEPART(MONTH, Date_Made__c) = 3 and DATEPART(Year, Date_Made__c) = 2017 and ch.act_date <= Date_Made__c and call_type in (0,2,4)
GROUP BY l.Id
