...
-- Clear Crit 3 close tables

IF OBJECT_ID('NewVoiceMedia..Close_Clients_Crit3') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_Clients_Crit3
	END

IF OBJECT_ID('NewVoiceMedia..Close_ToxicSIC_Crit3') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_ToxicSIC_Crit3
	END

IF OBJECT_ID('NewVoiceMedia..Close_BadCompany_Crit3') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_BadCompany_Crit3
	END

IF OBJECT_ID('NewVoiceMedia..Close_BadDomain_Crit3') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_BadDomain_Crit3
	END

IF OBJECT_ID('NewVoiceMedia..Close_ToxicList_Crit3') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_ToxicList_Crit3
	END

IF OBJECT_ID('NewVoiceMedia..Close_MLBranch_Crit3') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_MLBranch_Crit3
	END

-- Load Crit 3 close tables

SELECT l.Id, Phone
INTO NewVoiceMedia..Close_Clients_Crit3
FROM Salesforce..Lead l
...
FROM NewVoiceMedia..Close_Clients_Crit3

SELECT l.Id, l.Phone
INTO NewVoiceMedia..Close_ToxicSIC_Crit3
FROM Salesforce..Lead l
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit3 cl ON l.Id = cl.Id
...
FROM NewVoiceMedia..Close_ToxicSIC_Crit3

SELECT l.Id, l.Phone
INTO NewVoiceMedia..Close_BadCompany_Crit3
FROM Salesforce..Lead l 
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit3 cc ON l.Id = cc.Id
left outer join NewVoiceMedia..Close_ToxicSIC_Crit3 t ON l.Id = t.Id
...
FROM NewVoiceMedia..Close_BadCompany_Crit3

SELECT l.Id, l.Phone
INTO NewVoiceMedia..Close_BadDomain_Crit3
FROM Salesforce..Lead l
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit3 cc ON l.Id = cc.Id
left outer join NewVoiceMedia..Close_ToxicSIC_Crit3 t ON l.Id = t.Id
left outer join NewVoiceMedia..Close_BadCompany_Crit3 bc ON l.Id = bc.Id
...
FROM NewVoiceMedia..Close_BadDomain_Crit3

SELECT l.Id, l.Phone
INTO NewVoiceMedia..Close_ToxicList_Crit3
FROM Salesforce..Lead l
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit3 cc ON l.Id = cc.Id
left outer join NewVoiceMedia..Close_ToxicSIC_Crit3 t ON l.Id = t.Id
left outer join NewVoiceMedia..Close_BadCompany_Crit3 bc ON l.Id = bc.Id
left outer join NewVoiceMedia..Close_BadDomain_Crit3 bd ON l.Id = bd.Id
...
FROM NewVoiceMedia..Close_ToxicList_Crit3

SELECT l.ID, l.Phone
INTO NewVoiceMedia..Close_MLBranch_Crit3
FROM Salesforce..Lead l
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit3 cc ON l.Id = cc.Id
left outer join NewVoiceMedia..Close_ToxicSIC_Crit3 t ON l.Id = t.Id
left outer join NewVoiceMedia..Close_BadCompany_Crit3 bc ON l.Id = bc.Id
left outer join NewVoiceMedia..Close_BadDomain_Crit3 bd ON l.Id = bd.Id
left outer join NewVoiceMedia..Close_ToxicList_Crit3 tt ON l.Id  = tt.Id
...
FROM NewVoiceMedia..Close_MLBranch_Crit3
