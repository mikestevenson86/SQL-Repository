...
-- Clear Crit 2 close tables

IF OBJECT_ID('NewVoiceMedia..Close_Clients_Crit2') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_Clients_Crit2
	END

IF OBJECT_ID('NewVoiceMedia..Close_ToxicSIC_Crit2') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_ToxicSIC_Crit2
	END

IF OBJECT_ID('NewVoiceMedia..Close_BadCompany_Crit2') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_BadCompany_Crit2
	END

IF OBJECT_ID('NewVoiceMedia..Close_BadDomain_Crit2') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_BadDomain_Crit2
	END

IF OBJECT_ID('NewVoiceMedia..Close_ToxicList_Crit2') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_ToxicList_Crit2
	END

IF OBJECT_ID('NewVoiceMedia..Close_MLBranch_Crit2') IS NOT NULL
	BEGIN
		DROP TABLE NewVoiceMedia..Close_MLBranch_Crit2
	END

-- Load Crit 2 close tables

SELECT l.Id, Phone
INTO NewVoiceMedia..Close_Clients_Crit2
FROM Salesforce..Lead l
...
FROM NewVoiceMedia..Close_Clients_Crit2

SELECT l.Id, l.Phone
INTO NewVoiceMedia..Close_ToxicSIC_Crit2
FROM Salesforce..Lead l
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit2 cl ON l.Id = cl.Id
...
FROM NewVoiceMedia..Close_ToxicSIC_Crit2

SELECT l.Id, l.Phone
INTO NewVoiceMedia..Close_BadCompany_Crit2
FROM Salesforce..Lead l 
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit2 cc ON l.Id = cc.Id
left outer join NewVoiceMedia..Close_ToxicSIC_Crit2 t ON l.Id = t.Id
...
FROM NewVoiceMedia..Close_BadCompany_Crit2

SELECT l.Id, l.Phone
INTO NewVoiceMedia..Close_BadDomain_Crit2
FROM Salesforce..Lead l
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit2 cc ON l.Id = cc.Id
left outer join NewVoiceMedia..Close_ToxicSIC_Crit2 t ON l.Id = t.Id
left outer join NewVoiceMedia..Close_BadCompany_Crit2 bc ON l.Id = bc.Id
...
FROM NewVoiceMedia..Close_BadDomain_Crit2

SELECT l.Id, l.Phone
INTO NewVoiceMedia..Close_ToxicList_Crit2
FROM Salesforce..Lead l
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit2 cc ON l.Id = cc.Id
left outer join NewVoiceMedia..Close_ToxicSIC_Crit2 t ON l.Id = t.Id
left outer join NewVoiceMedia..Close_BadCompany_Crit2 bc ON l.Id = bc.Id
left outer join NewVoiceMedia..Close_BadDomain_Crit2 bd ON l.Id = bd.Id
...
FROM NewVoiceMedia..Close_ToxicList_Crit2

SELECT l.ID, l.Phone
INTO NewVoiceMedia..Close_MLBranch_Crit2
FROM Salesforce..Lead l
left outer join Salesforce..RecordType rt ON l.RecordTypeId = rt.Id
left outer join NewVoiceMedia..Close_Clients_Crit2 cc ON l.Id = cc.Id
left outer join NewVoiceMedia..Close_ToxicSIC_Crit2 t ON l.Id = t.Id
left outer join NewVoiceMedia..Close_BadCompany_Crit2 bc ON l.Id = bc.Id
left outer join NewVoiceMedia..Close_BadDomain_Crit2 bd ON l.Id = bd.Id
left outer join NewVoiceMedia..Close_ToxicList_Crit2 tt ON l.Id  = tt.Id
...
FROM NewVoiceMedia..Close_MLBranch_Crit2
