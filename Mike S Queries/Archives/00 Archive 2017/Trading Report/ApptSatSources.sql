SELECT
case when [Generic Made/Sat Criteria] in ('Outbound','Outbound Marketing') then 'Outbound' else 'Inbound' end Category,
[Generic Made/Sat Criteria], 
...
(
SELECT 
case when tds.[Generic Made/Sat Criteria] in ('Outbound','Outbound Marketing') then 'Outbound' else 'Inbound' end Category,
tds.[Generic Made/Sat Criteria], 
...
GROUP BY
case when tds.[Generic Made/Sat Criteria] in ('Outbound','Outbound Marketing') then 'Outbound' else 'Inbound' end,
tds.[Generic Made/Sat Criteria]
...
GROUP BY
case when [Generic Made/Sat Criteria] in ('Outbound','Outbound Marketing') then 'Outbound' else 'Inbound' end,
[Generic Made/Sat Criteria]