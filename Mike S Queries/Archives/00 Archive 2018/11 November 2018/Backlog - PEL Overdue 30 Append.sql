INSERT INTO SalesforceReporting..Backlog_PEL_Overdue_ThirtyDays
(
[DateStamp]
,[Company Name]
,[Sage Code]
...
FROM [database].shorthorn.dbo.cit_sh_dealsPEL AS p1 	
	...
	AND (p1.sysRequired = 1) AND ((DATEADD(dd,10,d1.signDate) < GETDATE() + 30) AND (p1.initialContact IS NULL)) --
...
FROM [database].shorthorn.dbo.cit_sh_dealsPEL AS p1 	
	...
	WHERE (d1.dealType IN (2, 3, 6, 12, 15)) AND (c1.active = 1) AND (s1.active = 1) AND (d1.dealStatus IN (1, 6, 9, 11, 12, 13, 14, 15, 16, 17)) 	AND (d1.enabled = 1) 
	AND (onHold = 0) AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND (p1.pelDealServiceType = 1) AND ((DATEADD(dd,28,d1.signDate) < GETDATE()+30) AND (p1.firstVisit IS NULL and (p1.firstVisitBooked is null OR firstVisitBooked < GETDATE()))) 
...
--,d1.onHold, d1.onHoldSince, d1.offHoldSince
--,p1.firstDraftRetrievalBooked, p1.firstDraftRetrievalDone, p1.secondDraftRetrievalBooked,p1.secondDraftRetrievalDone, p1.thirdDraftRetrievalBooked,p1.thirdDraftRetrievalDone 
,a.S__c Segment
FROM [database].shorthorn.dbo.cit_sh_dealsPEL AS p1 	
	INNER JOIN [database].shorthorn.dbo.cit_sh_deals AS d1 ON p1.dealID = d1.dealID 				
	INNER JOIN [database].shorthorn.dbo.cit_sh_sites AS s1 ON p1.siteID = s1.siteID and s1.HeadOffice = 1			
	...
	LEFT JOIN [database].shorthorn.dbo.cit_sh_busType as b on b.busTypeID = c1.busType
		LEFT JOIN [database].shorthorn.dbo.cit_sh_businessSectors as bs on bs.id = b.businessSectorID 	
	WHERE (d1.dealType IN (2, 3, 6, 12, 15)) AND (c1.active = 1) AND (s1.active = 1) AND (d1.dealStatus IN (1, 6, 9, 11, 12, 13, 14, 15, 16, 17)) 	AND (d1.enabled = 1) 
	AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (onHold = 0) 
	AND (p1.sysRequired = 1) AND 
	((p1.firstDraftToClient is not null AND p1.firstDraftReturned is null AND firstDraftToClient < = DATEADD(dd,-2,GETDATE()+30) and (p1.[firstDraftRetrievalBooked] < GETDATE() or [firstDraftRetrievalBooked] is null)) OR
	(p1.secDraftToClient is not null AND p1.secDraftReturned is null AND secDraftToClient < = DATEADD(dd,-2,GETDATE()+30) and (p1.[secondDraftRetrievalBooked] < GETDATE() or [secondDraftRetrievalBooked] is null)) OR
	(p1.thirDraftToClient is not null AND p1.thirDraftReturned is null AND thirDraftToClient < = DATEADD(dd,-2,GETDATE()+30) and (p1.[thirdDraftRetrievalBooked] < GETDATE() or [thirdDraftRetrievalBooked] is null)))
...
FROM [database].shorthorn.dbo.cit_sh_dealsPEL AS p1 	
	...
	WHERE (d1.dealType IN (2, 3, 6, 12, 15)) AND (c1.active = 1) AND (s1.active = 1) AND (d1.dealStatus IN (1, 6, 9, 11, 12, 13, 14, 15, 16, 17)) 	AND (d1.enabled = 1) 
	AND (onHold = 0) AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND  ((DATEADD(dd,2,p1.inMakeUp) < GETDATE()+30) AND (p1.installed IS NULL and (p1.installBooked is null OR p1.installBooked < GETDATE()))) 
...
FROM [database].shorthorn.dbo.cit_sh_dealsPEL AS p1 	
	...
	AND ((DATEADD(mm,3,p1.installed) < GETDATE()+30) AND (p1.followUp3 IS NULL)) 
...
SELECT c1.companyName,c1.sageCode, a.Id,p1.pelDealServiceType, d1.dealLength, u.FullName,t.title, c.fName, c.sName, s1.postcode, s1.genTel,s1.genEmail,d1.signDate,
	...
	AND ((DATEADD(mm,12,p1.installed) < GETDATE()+30) AND (p1.followUp12 IS NULL))) 
...
UNION ALL
	...
	AND ((DATEADD(mm,24,p1.installed) < GETDATE()+30) AND (p1.followUp24 IS NULL))) 
...
UNION ALL
	...
	AND (onHold = 0) AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND 
	((p1.pelDealServiceType = 1 AND d1.dealLength >=48 AND d1.dealLength < 60 AND (installed is not null) and (installBooked is null OR installBooked < GETDATE())) AND ((DATEADD(mm,36,p1.installed) < GETDATE()+30) AND (p1.followUp36 IS NULL)))
...
UNION ALL
	...
	AND (onHold = 0)  AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND 
	((d1.dealLength >= 60 AND DATEADD(mm,36,d1.signDate) < GETDATE()+30) AND (p1.midTermReview IS NULL)) 
...
UNION ALL
	...
	WHERE (d1.dealType IN (2, 3, 6, 12, 15)) AND (c1.active = 1) AND (s1.active = 1) AND (d1.dealStatus IN (1, 6, 9, 11, 12, 13, 14, 15, 16, 17)) 	AND (d1.enabled = 1) 
	AND (onHold = 0) AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND (((p1.pelDealServiceType = 2) AND d1.signDate < GETDATE()+30)  AND (p1.docReview IS NULL and p1.docReviewBooked is null)) 
...
UNION ALL
	...
	AND (onHold = 0) AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND 
	((((p1.pelDealServiceType = 1 AND d1.dealLength >= 60) AND DATEADD(mm,48,d1.signDate) < GETDATE()+30)  AND (p1.docReviewplus12 IS NULL)) OR 
	(((p1.pelDealServiceType = 2 AND d1.dealLength >= 24 AND d1.dealLength < 51) AND DATEADD(DD,10, DATEADD(mm,12,d1.signDate)) < GETDATE()+30)  AND (p1.docReviewplus12 IS NULL)))   
...
UNION ALL
	...
	AND (onHold = 0) AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND 
	((((p1.pelDealServiceType = 1 AND d1.dealLength >= 72) AND DATEADD(mm,60,d1.signDate) < GETDATE()+30)  AND (p1.docReviewplus24 IS NULL)) OR 
	(((p1.pelDealServiceType = 2 AND d1.dealLength >= 36 AND d1.dealLength < 60) AND DATEADD(DD,10, DATEADD(mm,24,d1.signDate)) < GETDATE()+30)  AND (p1.docReviewplus24 IS NULL)))   
...
UNION ALL
	...
	AND (onHold = 0) AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND 
	(((p1.pelDealServiceType = 2 AND d1.dealLength >= 48 AND d1.dealLength < 60) AND DATEADD(dd,10, DATEADD(mm,36,d1.signDate)) < GETDATE()+30)  AND (p1.docReviewplus36 IS NULL)) 
	
UNION ALL
	
	SELECT c1.companyName,c1.sageCode, a.Id,p1.pelDealServiceType, d1.dealLength, u.FullName, t.title, c.fName, c.sName, s1.postcode, s1.genTel,s1.genEmail,d1.signDate,
	d1.renewDate,p1.agreeToConsul,p1.installed,p1.inMakeUp, p1.firstDraftToClient, secDraftToClient,thirDraftToClient, '12 Months Not Installed' as [Call Type], d1.cost as DealValue, bs.title as Sector 
	,a.S__c Segment
	FROM [database].shorthorn.dbo.cit_sh_dealsPEL AS p1 	
	INNER JOIN [database].shorthorn.dbo.cit_sh_deals AS d1 ON p1.dealID = d1.dealID 				
	INNER JOIN [database].shorthorn.dbo.cit_sh_sites AS s1 ON p1.siteID = s1.siteID 		
	...
	AND (onHold = 0) AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND 
	(((p1.pelDealServiceType = 1) AND ((installed is null and (installBooked is null or installBooked < GETDATE())) AND followUp12 is null) AND (DATEADD(mm,12,d1.signDate) <= GETDATE()+30)) AND (p1.installed is null and (installBooked is null or installBooked< GETDATE()))) 
...
UNION ALL
	...
	AND (onHold = 0) AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND 
	(((p1.pelDealServiceType = 1) AND ((installed is null and (installBooked is null or installBooked < GETDATE())) AND followUp24 is null) AND (DATEADD(mm,24,d1.signDate) <= GETDATE()+30)) AND (p1.installed is null and (installBooked is null or installBooked< GETDATE()))) 
...
union all
	...
	AND (onHold = 0)  AND (d1.aiOnly IS NULL OR d1.aiOnly <= GETDATE()) 	AND (d1.renewDate >= GETDATE()) AND (d1.signDate <= GETDATE()) 	
	AND (p1.sysRequired = 1) AND 
	(((p1.pelDealServiceType = 1) AND ((installed is null and (installBooked is null or installBooked < GETDATE())) AND followUp36 is null) AND (DATEADD(mm,36,d1.signDate) <= GETDATE()+30)) AND (p1.installed is null and (installBooked is null or installBooked< GETDATE()))) 
