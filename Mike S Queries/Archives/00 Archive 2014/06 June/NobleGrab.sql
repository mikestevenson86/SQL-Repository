...
REPLACE(b.[name],',','') city, 
''county, 
REPLACE(l.PostalCode,',','') postal_code, 
...
inner join salesforce..[User] b on l.OwnerId collate latin1_general_CS_AS = b.Id collate latin1_general_CS_AS

WHERE b.Name = 'Marina Ashman' and
l.[status] = 'Open'
